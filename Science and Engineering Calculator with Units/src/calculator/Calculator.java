 ...
 * 
 * @author Lyn Robert Carter and Sumit Kumar 170002
 *
...
public class Calculator extends Application {
	...
	public final static double WINDOW_WIDTH = 1050;
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Sumit Kumar's Science and Engineering Calclator with Units");				// Label the stage (a window)
